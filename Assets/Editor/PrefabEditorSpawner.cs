...
public class PrefabEditorSpawner : MonoBehaviour
{
    ...
    {
        var prefabPath = "Assets/Prefabs/Pixel.prefab";
        ...
        for (var y = 0; y < height; y++)
        {
            ...
            {
                var pixel = (GameObject)PrefabUtility.InstantiatePrefab(
                    prefab,
                    root.transform);
                pixel.transform.localPosition = new(
                    x * pixelSpacing, y * pixelSpacing, 0);
